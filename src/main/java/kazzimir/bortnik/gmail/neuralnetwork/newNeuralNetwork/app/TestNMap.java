...
public class TestNMap {
    ...
    public static void main(String[] args) {
        ...
        double[] target = new double[]{0.1, 0.5, 0.2};
        int sizeInputData = 4;
        int colEpoh = 800;
        ...
        NeuralNetwork neuralNetwork = new NeuralNetwork(sizeInputData, 4,  3);
...
/*
        NeuralNetwork2 neuralNetwork2 = new NeuralNetwork2(sizeInputData, 2, 3, 3);
